...
<div class="">
    <a href="javascript:void(0)" class=" font-14 {$this->grid->getRowName()}-orderable" data-id="{$this->getKey()}" data-direction="1" data-orderby="{$this->getDirection()}">
    ...
    <a href="javascript:void(0)" class=" font-14 {$this->grid->getRowName()}-orderable" data-id="{$this->getKey()}" data-direction="0" data-orderby="{$this->getDirection()}">
